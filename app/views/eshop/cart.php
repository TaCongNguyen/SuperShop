				...
				<table class="table table-condensed">
					...
					<tbody>
						...
						<?php else: ?>
							...
							<div style="font-size: 18px;text-align: center;padding: 6px;">Không có sản phẩm trong giỏ.</div>
						<?php endif; ?>
					</tbody>
				</table><div class="pull-right" style="font-size: 25px;">Tổng cộng: $<?=number_format($sub_total,2)?></div>
			</div>
			<a href="<?=ROOT?>checkout">
				<input type="button" class="btn btn-warning pull-right" value="Thanh toán >" name="">
			</a>
			<a href="<?=ROOT?>shop">
