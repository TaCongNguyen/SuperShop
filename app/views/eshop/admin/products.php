                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          ...
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> Sản phẩm <button class="btn btn-primary btn-xs" onclick="show_add_new(event)"><i class="fa fa-plus"></i> Thêm mới</button></h4>
	                  	  	  
	                  	  	  <!--add new product-->
	                  	  	  <div class="add_new add_edit_panel hide">
 	                  	  	   
				                  <h4 class="mb"><i class="fa fa-angle-right"></i> Thêm mới</h4>
			                      <form class="form-horizontal style-form" method="post">
			                          ...
			                          <br><br style="clear: both;">
			                          <div class="form-group">
			                              <label class="col-sm-2 col-sm-2 control-label">Loại hàng</label>
			                              <div class="col-sm-10">
			                          ...
			                          <div class="form-group">
			                              ...
			                              <div class="col-sm-10">
 											...
 											<br><br style="clear: both;">
			                          <div class="form-group">
			                              <label class="col-sm-2 col-sm-2 control-label">Ảnh 2( Tuỳ chọn):</label>
			                              <div class="col-sm-10">
 											...
 											<br><br style="clear: both;">
			                          <div class="form-group">
			                              <label class="col-sm-2 col-sm-2 control-label">Ảnh 3( Tuỳ chọn):</label>
			                              <div class="col-sm-10">
 											...
 											<br><br style="clear: both;">
			                          <div class="form-group">
			                              <label class="col-sm-2 col-sm-2 control-label">Ảnh 4( Tuỳ chọn):</label>
			                              <div class="col-sm-10">
					            ...
					            <br><br>
				                  ...
				                  <h4 class="mb"><i class="fa fa-angle-right"></i> Sửa</h4>
			                      <form class="form-horizontal style-form" method="post">
			                          <div class="form-group">
			                              <label class="col-sm-2 col-sm-2 control-label">tên; </label>
			                              <div class="col-sm-10">
			                          ...
			                          <div class="form-group">
			                              ...
			                              <div class="col-sm-10">
              	  	  					...
              	  	  					<button type="button" class="btn btn-warning" onclick="show_edit_product(0,'',false)" style="position:absolute;bottom:10px; left:10px;">Huỷ</button>
