                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> Loại mặt hàng <button class="btn btn-primary btn-xs" onclick="show_add_new(event)"><i class="fa fa-plus"></i> Add New</button></h4>
	                  	  	  
	                  	  	  <!--add new category-->
	                  	  	  <div class="add_new hide">
 	                  	  	   
				                  <h4 class="mb"><i class="fa fa-angle-right"></i> Thêm Loại hàng</h4>
			                      <form class="form-horizontal style-form" method="post">
			                          <div class="form-group">
			                              <label class="col-sm-2 col-sm-2 control-label">Tên loại hàng : </label>
			                              <div class="col-sm-10">
			                          ...
			                          <div class="form-group">
			                              <label class="col-sm-2 col-sm-2 control-label">Mục lớn ( Tuỳ chọn)</label>
			                              <div class="col-sm-10">
					            ...
					            <br><br>
				                  ...
				                  <h4 class="mb"><i class="fa fa-angle-right"></i> Sửa loại hàng</h4>
			                      <form class="form-horizontal style-form" method="post">
			                          <div class="form-group">
			                              <label class="col-sm-2 col-sm-2 control-label">Tên loại hàng</label>
			                              <div class="col-sm-10">
              	  	  					...
              	  	  					<br><br style="clear: both;"><br>
			                          <div class="form-group">
			                              <label class="col-sm-2 col-sm-2 control-label">Mục lớn</label>
			                              <div class="col-sm-10">
              	  	  					...
              	  	  					<button type="button" class="btn btn-warning" onclick="show_edit_category(0,'',event)" style="position:absolute;bottom:10px; left:10px;">Huỷ</button>
                              ...
                              <thead>
                              <tr>
                                  <th><i class="fa fa-bullhorn"></i> Loại hàng</th>
                                   <th><i class=" fa fa-table"></i> Mục lớn</th>
...
<script type="text/javascript">
	...
	function show_add_new()// show hộp thêm sản phẩm
	{
	...
	function collect_data(e) // lấy data nhập vào
	{

		var category_input = document.querySelector("#category");
		if(category_input.value.trim() == "" || !isNaN(category_input.value.trim()))
		{
			alert("Hãy điền thông tin phù hợp");
		}
	...
	function send_data(data = {})// gửi data đi
	{
		...
		ajax.send(JSON.stringify(data));// gửi data đi
	}

	function handle_result(result)// xử lí kết quả đến ajax
	{
