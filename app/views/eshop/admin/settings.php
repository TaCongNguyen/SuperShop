...
<form method="post" enctype="multipart/form-data">
	<table class="table table-striped table-advance table-hover">
		...
		<?php if($type == "socials"):?>
			...
			<thead>
				<tr><th>Cài đặt</th><th>Giá trị</th></tr>
			</thead>
			<tbody>
		...
		<?php elseif($type == "slider_images"):?>
			...
			<?php if($action == "show"):?>
				<thead>
					<tr><th>Header 1 </th><th>Header 2 </th><th>Nội dung</th><th>Link sản phẩm</th><th>Ảnh</th><th>Disabled</th></tr>
				</thead>
				<tbody>
			...
			<?php elseif($action == "add"):?>
				...
				<div class="form-group">
					<label for="header1_text">Header 1 </label>
