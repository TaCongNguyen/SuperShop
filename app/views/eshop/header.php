...
<head>
    ...
    <title><?= $data['page_title']?> | Super Shop</title> <!-- Tiêu đề động-->
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li><a href="<?=ROOT?>index" class="<?= $page_title == "Home" ? "active" : ""; ?>">Trang chủ</a></li>
								...
								<li><a href="<?=ROOT?>contact-us" class="<?= $page_title == "Contact-us" ? "active" : ""; ?>">Liên hệ</a></li>
							</ul>
						</div>
					</div>
